...
<div class="carnetdebord view large-11 medium-12 columns content">
    ...
    <div class="row">
     ...
     <?php 
        ...
        echo $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $carnetdebord->CodeEntree],array("class"=>"button"), ['confirm' => __('Êtes vous sur de vouloir supprimer l\'entrée : {0}?', $carnetdebord->Sujet)]); 
    ?>
</div>
</div>
