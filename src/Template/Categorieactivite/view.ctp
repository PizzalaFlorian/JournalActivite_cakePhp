<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Categorieactivite'), ['action' => 'delete', $categorieactivite->CodeCategorieActivite], ['confirm' => __('Êtes vous sur de vouloir supprimer # {0}?', $categorieactivite->CodeCategorieActivite)]) ?> </li>
